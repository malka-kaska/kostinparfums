...
## Дата: 2026-07-06
## Източник: `marketing/meta-ads-campaign.md` + 10 subagent deliverables

---

# Преговор на наличните ресурси преди старт
- ✅ `claude-fable-5` via `copilot-acp`: конфигуриран и работещ
...
- `marketing/meta-ads-campaign.md`
- `marketing/12-product-shortlist.md`
- `marketing/30-day-optimization-calendar.md`
